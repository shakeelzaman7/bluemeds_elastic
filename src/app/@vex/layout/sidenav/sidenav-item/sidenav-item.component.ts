...
import { NavigationDropdown, NavigationItem, NavigationLink, NavigationAnchor } from '../../../interfaces/navigation-item.interface';
...
export class SidenavItemComponent implements OnInit, OnChanges {
  ...
  isAnchor = this.navigationService.isAnchor;
